...
namespace AbstraxArtStore.Controllers
{
    public class CartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CartId,CustomerId,ProductId,CartQuantity,TotalPrice")] Cart cart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CartId,CustomerId,ProductId,CartQuantity,TotalPrice")] Cart cart)
        {
            if (id != cart.CartId)
            {
                return NotFound();
